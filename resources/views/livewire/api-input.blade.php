   ...
   <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
       ...
       <div class="flex items-center justify-between px-3 py-2 border-t ">
           ...
           <div class="flex ps-0 space-x-1 rtl:space-x-reverse sm:ps-2">
               <button type="button" class="inline-flex justify-center items-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white ">
...
@if (session('generatedText'))
    ...
    <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" readonly>{{ session('generatedText') }}</textarea>
@endif
</div>